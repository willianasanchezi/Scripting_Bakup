...
function borrarcarpeta ()
{
    ...
    $ruta1 = "C:\Windows\Temp\" # Colocamos la ruta en una variable
    ...
    if ($existeruta -eq $True) # Validamos si el resultado del test es True o False
        ...
        Remove-Item C:\Windows\Temp\ -Recurse # Inicio Borrar Carpetas
        Remove-Item C:\Windows\SoftwareDistribution\ -Recurse # Inicio Borrar Carpetas        
        }
    else
        {        
