...
Get-DatabaseData -verbose -connectionString 'Server=localhost\SQLEXPRESS;Database=Inventory;Trusted_Connection=True;' -isSQLServer-query "SELECT * FROM Computers"
#>
Get-DatabaseData -verbose -connectionString 'Server=templaurel.mincomunicaciones.gov.co\SERVICEMANAGER;Database=ServiceManager;Trusted_Connection=True;' -isSQLServer-query "select * from AlertCustomField"
Invoke-DatabaseQuery -verbose -connectionString 'Server=templaurel.mincomunicaciones.gov.co\SERVICEMANAGER;Database=ServiceManager;Trusted_Connection=True;' -isSQLServer-query "select * from AlertCustomField"