...
la linea echo "Test" se ejecutara siempre y cuando exista la carpeta
#>
    do
        {       
        $ruta = Test-Path C:\1      
...
#>
    ...
    while (!$ruta) # La carpeta no existe
